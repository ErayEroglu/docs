...
[Upstash CLI](https://github.com/upstash/cli). Select the same region as your
AWS Lambda to minimize latency. Copy the `UPSTASH_REDIS_REST_URL` and
...
â Project successfully created in aws-node-http-api-project folder
