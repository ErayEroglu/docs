...
- This integration can only be executed one time. If you would like to extend the list of the team in the integration, please re-establish the integration from scratch.
...
Once you've selected your Datadog account, Upstash will begin the integration process. Please be patient while the metrics are being retrieved. This may take a few moments.

And here we go, metrics will be available in the Upstash Overview Dashboard!

![upstash-dashboard.png](/img/datadog/upstash-dashboard.png)

## **Step 6: Datadog Integration Removal Process**

Navigate to the Integration Tab on your Datadog account.

Once logged in, navigate to the "Integration" tab and continue with the Datadog part. If you would like to remove your integration between Upstash and your Datadog account, press "Remove".

### Confirm Removal:

Upstash will suspend all metric publishing processes after you remove the Datadog integration.
